...
export function getWorkspaceEnv(options = {}) {
  ...
  const env = {
    ...
    BEFORE_ALL: process.env.BEFORE_ALL || process.env[`BEFORE_ALL_${buildType}`],
    WORKSPACE_NAME: process.env.WORKSPACE_NAME || process.env[`WORKSPACE_NAME_${buildType}`],
    APP_IDENTIFIER: process.env.APP_IDENTIFIER || process.env[`APP_IDENTIFIER_${buildType}`],
    FIREBASE_IOS_APP_ID: process.env.FIREBASE_IOS_APP_ID || process.env[`FIREBASE_IOS_APP_ID_${buildType}`],
    FIREBASE_CREDENTIALS: process.env.FIREBASE_CREDENTIALS || process.env[`FIREBASE_CREDENTIALS_${buildType}`],
    FIREBASE_ANDROID_APP_ID: process.env.FIREBASE_ANDROID_APP_ID || process.env[`FIREBASE_ANDROID_APP_ID_${buildType}`],
